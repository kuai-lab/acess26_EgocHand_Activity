...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume_path',default='./jy/ckpts/0523_gibson_infer_singlegpu/checkpoint_15.pth')
    # parser.add_argument('--resume_path',default='./gibson/ckpts/0523_test/checkpoint_45.pth')
    ...
    # parser.add_argument("--val_split", default="train", choices=["test", "train", "val"])#지금 train 데이터로 테스트 중입니다
