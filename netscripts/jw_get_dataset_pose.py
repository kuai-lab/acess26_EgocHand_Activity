...
# from datasets import jw_seqset_pose,fhbhands,h2ohands,mhavhands
from datasets import jw_seqset_pose,fhbhands,h2ohands,mhavhands_gibson
...
def get_dataset_pose(
    ...
    if dataset_name == "fhbhands":
        ...
        pose_dataset = mhavhands_gibson.MHAVhands(dataset_folder="../data_MHAV",
                                    split=split,
                                    ntokens_action=128,
                                    spacing=2,
