...
from datasets import seqset_htt_mm_depth,fhbhands,h2ohands, mhavhands_mm_depth
...
def get_dataset_htt(
    ...
    if dataset_name == "fhbhands":
        ...
        pose_dataset = mhavhands_mm_depth.MHAVhands(dataset_folder="../data_MHAV",
                                    split=split,
                                    ntokens_action=128,
                                    spacing=2,
    ...
    dataset = seqset_htt_mm_depth.SeqSet(
