...
from datasets import seqset_htt,fhbhands,h2ohands, mhavhands_bidirection_skip
...
def get_dataset_htt(
    ...
    if dataset_name == "fhbhands":
        ...
        pose_dataset = mhavhands_bidirection_skip.MHAVhands(dataset_folder="../data_MHAV",
                                    split=split,
                                    ntokens_action=128,
                                    spacing=2,
