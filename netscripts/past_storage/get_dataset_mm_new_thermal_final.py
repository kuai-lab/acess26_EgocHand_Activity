...
from datasets import seqset_htt_mm_origin,fhbhands,h2ohands, mhavhands_mm_new_thermal_final
...
def get_dataset_htt(
    ...
    if dataset_name == "fhbhands":
        ...
        pose_dataset = mhavhands_mm_new_thermal_final.MHAVhands(dataset_folder="../data_MHAV",
                                    split=split,
                                    ntokens_action=128,
                                    spacing=2,
    ...
    dataset = seqset_htt_mm_origin.SeqSet(
