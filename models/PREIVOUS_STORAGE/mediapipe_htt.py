...
class TemporalNet(torch.nn.Module):
    def __init__(self,  is_single_hand,
        ...
        self.ntokens_pose= ntokens_pose #16
        self.ntokens_action=ntokens_action #128
    ...
    def forward(self, batch_flatten, epoch=0, train=True, verbose=False):
        ...
        # mp_2d_flat = mp_keypoints_tensor.view(B, -1).cuda() # (B, 84)
        # flatten_hpose2d = mp_2d_flat # (B, 84)
        
        
        
        # == gibson ==
        # mp_keypoints_tensor = batch_flatten[BaseQueries.HANDKEYPOINTS].cuda() 
        # print("✅ mp_keypoints shape:", mp_keypoints_tensor.shape)
        # print("✅ flatten_imgs shape:", flatten_imgs.shape)
        ...
        print("flatten_ain_feature_olabel", flatten_ain_feature_olabel)
        ...
        print("flatten_ain_feature_hlabel_txt", flatten_ain_feature_hlabel_txt)
        ...
        print("flatten_ain_feature 3개 concat", flatten_ain_feature)
        ...
        print("flatten_ain_feature hand type concat", flatten_ain_feature)
        ...
        print("batch_seq_ain_feature", batch_seq_ain_feature)
