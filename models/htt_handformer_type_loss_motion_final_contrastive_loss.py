...
class TemporalNetHandFormer(nn.Module):
    def __init__(self, 
        ...
        # self.handtype_proj = nn.Linear(self.hlabel_features.shape[1], transformer_d_model).cuda()  # CLIP D → transformer D
    ...
    def forward(self, batch_flatten, epoch=0, train=True, verbose=False, return_atten_map=False):
        ...
        clip_feats = self.hlabel_features[pred_verb].float()   # [B*T, D_clip] = [960, 512]
        # clip_feats_proj = self.handtype_proj(clip_feats)  # [B*T, D_transformer]
