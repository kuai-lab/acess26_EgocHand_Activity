...
class GatedCrossModalAttention(nn.Module):
    def __init__(self, embed_dim=512, num_heads=8):
        ...
        # query (e.g. RGB)의 정보만으로 "이 attention output을 신뢰해도 되는가?" 판단
    ...
    def forward(self, q, kv):
        ...
        # Gating: query 기반 importance score
        gate_weight = self.gate(q)          # [B, 1, D], range [0~1]
        
        # Weighted attention output
        gated = attn_out * gate_weight      # element-wise modulate
