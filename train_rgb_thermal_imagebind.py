...
from netscripts import reloadmodel, get_dataset_mm_new_thermal_final   
 # mhavhands_mm_new_thermal_final(rgb, warped_thermal)
from torch.utils.tensorboard import SummaryWriter
from netscripts.get_dataset_mm_new_thermal_final import DataLoaderX 
...
def main(args):
    ...
    train_dataset, _ = get_dataset_mm_new_thermal_final.get_dataset_htt(
        args.train_dataset,
