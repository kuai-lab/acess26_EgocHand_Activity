# 지완님이 짜신 코드 이름은 eval 인데 train으로 설정되어 있는 상태
...
# from datasets import collate_gibson as collate

from models.mediapipe_htt import TemporalNet
from netscripts import epochpass
from netscripts import reloadmodel, jw_get_dataset_pose
...
def main(args):
    ...
    train_dataset, _ = jw_get_dataset_pose.get_dataset_pose(
        args.train_dataset,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_tag',default='gibson_lee_0516') 
