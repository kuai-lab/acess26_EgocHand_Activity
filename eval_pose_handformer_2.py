...
from models.htt_handformer_type_loss_motion_final_contrastive_loss import TemporalNetHandFormer
from netscripts import get_dataset_rgb_wilor_former_two_hands
...
def main():
    ...
    val_dataset, _ = get_dataset_rgb_wilor_former_two_hands.get_dataset_htt(
        args.val_dataset,
