...
- [Ego-Bi Dataset](https://kuaicv.synology.me/weights/IEEE_Access_26/Egohand/dataset_MHAV.zip)
...
- [Pretrained Model](https://kuaicv.synology.me/weights/IEEE_Access_26/Egohand/ckpt.zip)
```bash
