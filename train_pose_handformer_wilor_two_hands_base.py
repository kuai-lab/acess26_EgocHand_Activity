...
from models.htt_handformer_type_loss import TemporalNetHandFormer
from netscripts import epochpass_handformer_loss_full
from netscripts import reloadmodel, get_dataset_rgb_wilor_former_two_hands 
from torch.utils.tensorboard import SummaryWriter
from netscripts.get_dataset_rgb_wilor_former_two_hands import DataLoaderX 
...
def main(args):
    ...
    train_dataset, _ = get_dataset_rgb_wilor_former_two_hands.get_dataset_htt(
        args.train_dataset,
    ...
    model= TemporalNetHandFormer(dataset_info=dataset_info,
                ...
                use_3d_pose=True, rgb_frames_to_use=-1)
