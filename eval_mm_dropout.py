...
from models.htt_mm_dropout_linear import TemporalNet
...
def main(args):
    ...
    val_dataset, _ = get_dataset_mm_new_thermal_final.get_dataset_htt(
        args.val_dataset,
...
if __name__ == "__main__":
    ...
    # parser.add_argument('--resume_path',default='./jy/hello3/checkpoint_40.pth')
    parser.add_argument('--resume_path',default='./jy/ckpts/linear_concat/checkpoint_17.pth')
    ...
    # 추가 
    parser.add_argument("--test_modalities", default=["rgb", "depth", "thermal"])
