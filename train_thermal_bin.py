...
from netscripts import reloadmodel, get_dataset_thermal
from torch.utils.tensorboard import SummaryWriter
from netscripts.get_dataset_thermal import DataLoaderX 
...
def main(args):
    ...
    train_dataset, _ = get_dataset_thermal.get_dataset_htt(
        args.train_dataset,
