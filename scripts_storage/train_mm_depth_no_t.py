...
from models.htt_mm_depth import TemporalNet
from netscripts import epochpass
from netscripts import reloadmodel, get_dataset_mm_depth 
from torch.utils.tensorboard import SummaryWriter
from netscripts.get_dataset_mm_depth import DataLoaderX 
...
def main(args):
    ...
    wandb.init(
    project="RGB-Depth-Linear-projection-test",
    name=args.experiment_tag,
    config=vars(args))

    print("**** Lets train on", args.train_dataset, args.train_split)

    train_dataset, _ = get_dataset_mm_depth.get_dataset_htt(
        args.train_dataset,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--experiment_tag',default='multi_modal') 
