...
if __name__ == '__main__':
    output_dir = "./wiLo/video/final_dual_view_unassemble"
    os.makedirs(output_dir, exist_ok=True)

    seq_list = [
        "unassemble_hexNut-bigBolt_hand_jl",
        "unassemble_hexNut-bolt-curvedMetalPlate_hand_jl",
        "unassemble_hexNut-bolt_hand_jl",
        "unassemble_nut-spacer-bigBolt2_hand_jl",
        "unassemble_hexNut-bigBolt2-spacer_hand_kl",
        "unassemble_hexNut-bigBolt3_hand_kl",
        "unassemble_hexNut-bolt-curvedMetalPlate_hand_kl",
        "unassemble_hexNut-bolt_hand_kl",
        "unassemble_hexNut-uBolt-metalPlate4_hand_kl",
        "unassemble_hexNut-washer-hexBolt-metalSpring-metalBlock6_hand_kl",
        "unassemble_hexNut-bigBolt3_hand_pc",
        "unassemble_hexNut-bigBolt_hand_pc",
        "unassemble_hexNut-bolt_hand_pc",
        "unassemble_hexNut-spacer-bigBolt2_hand_pc",
        "unassemble_hexNut-washer-silverHexBolt-metalPlate2_hand_pc",
        "unassemble_bigBolt3-hexNut_hand_sp",
        "unassemble_hexNut-bolt-curvedMetalPlate_hand_sp",
        "unassemble_hexNut-silverHugeHexBolt_hand_sp",
        "unassemble_hexNut-spacer-bigBolt2_hand_sp",
        "unassemble_hexNut-washer-silverHexBolt-metalPlate_hand_sp",
        "unassemble_hexNut-bigBolt3_hand_hg",
        "unassemble_hexNut-bigBolt_hand_hg",
        "unassemble_hexNut-bolt-curvedMetalPlate_hand_hg",
        "unassemble_hexNut-bolt_hand_hg",
        "unassemble_hexNut-uBolt-metalPlate4_hand_hg",
        "unassemble_hexNut-washer-blackHexBolt-metalPlate2_hand_hg",
        "unassemble_hexNut-washer-metalPlate-bolt-metalPlate2_hand_hg",
        "unassemble_hexNut-washer-metalPlateBolt-metalPlate_hand_hg",
        "unassemble_hexNut-washer-metalPlateBolt-woodBlock2_hand_hg",
        "unassemble_hexNut-washer-silverHugeHexBolt-woodBlock2_hand_hg",
        "unassemble_metalPlate5-metalBlock2-silverHexBolt_hand_hg",
        "unassemble_nut-spacer-bigBolt2_hand_hg"
    ]

    for seq in seq_list:
        parts = seq.split('_')
        subj = parts[-1]  # e.g., hand_jl → jl
        INPUT_IMAGE_FOLDER = f"../data_MHAV/unassemble/{subj}/{seq}/RGB_undistorted"
