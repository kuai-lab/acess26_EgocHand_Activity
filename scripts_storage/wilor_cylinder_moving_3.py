...
if __name__ == '__main__':
    output_dir = "./wiLo/video/final_dual_view_screw"
    os.makedirs(output_dir, exist_ok=True)

    seq_list = [
        "screw_woodChunk-countersunk_screwdriver_kl",
        "screw_woodChunk-roundHeadScrew_screwdriver_kl",
        "screw_woodChunk-silverHugeHexBolt_channelLockPliers_kl",
        "screw_woodChunk-socketCapScrew_socketDriver_kl",
        "screw_woodBlock2-counterchunk_screwdriver-largeBlackClamp_jl",
        "screw_woodChunk-roundHeadScrew_screwdriver_jl",
        "screw_countersunk-woodChunk_screwdriver_pc",
        "screw_countersunk-woodChunk_screwdriver_pc",
        "screw_woodChunk-roundHeadScrew_screwdriver_pc_hand_path",
        "screw_woodChunk-socketCapScrew_allenKey_pc",
        "screw_woodChunk-socketCapScrew_socketDriver_pc",
        "screw_woodBlock2-counterchunk_screwdriver-largeBlackClamp_sp",
        "screw_woodBlock2-counterchunk_screwdriver_sp",
        "screw_woodChunk-counterchunk_screwdriver_sp",
        "screw_woodChunk-countersunk_screwdriver_sp",
        "screw_woodChunk-roundHeadScrew_screwdriver_sp",
        "screw_woodBlock2-counterchunk_screwdriver_hg",
        "screw_woodBlock-counterchunk_screwdriver_hg",
        "screw_woodBlock-counterchunk_screwdriver-largeBlackClamp_hg",
        "screw_woodBlock-smallWood-counterchunk_screwdriver-largeBlackClamp_hg",
        "screw_woodChunk-roundHeadScrew_screwdriver_hg"
    ]

    for seq in seq_list:
        parts = seq.split('_')
        subj = parts[-1]  # e.g., screw_woodChunk-roundHeadScrew_screwdriver_hg → hg
        INPUT_IMAGE_FOLDER = f"../data_MHAV/screw/{subj}/{seq}/RGB_undistorted"
