...
from datasets import mhavutils_thermal
...
class MHAVhands(object):
    def __init__(
        ...
        # # self.split = split
        self.rgb_template = "thermal_raw_{:05d}.jpg"
        ...
        action_info, action_to_idx = mhavutils_thermal.get_action_infos(path_action_info)
        ...
        object_info, object_to_idx = mhavutils_thermal.get_object_infos(path_object_info)
        ...
        self.hand_labels, self.subjects_infos = mhavutils_thermal.get_all_hand_labels('../data_MHAV/annotation_0317.xlsx', self.rgb_root, self.rgb_template)
    ...
    #     window_starts,fulls= mhavutils_thermal.get_seq_map(sample_infos=self.sample_infos,video_lens=self.video_lens,
    ...
    def load_dataset(self):
        ...
        window_starts, fulls = mhavutils_thermal.get_seq_map(
