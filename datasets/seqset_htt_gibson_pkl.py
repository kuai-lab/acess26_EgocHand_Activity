...
class SeqSet(Dataset): 
    ...
    def __getitem__(self, idx, verbose=False):
        ...
        npy_filename = f"{detail_action_name}.npy" # 'assemble_hexNut-bigBolt3_hand_hg.npy'

        # NPY_PATH = "../data_MHAV" / action_category / subject / sequence_folder / npy_filename
        NPY_PATH = os.path.join(
                        "../data_MHAV", action_category, subject,  sequence_folder,npy_filename)
