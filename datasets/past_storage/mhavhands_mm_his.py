...
from datasets import mhavutils_mm_his
...
class MHAVhands(object):
    def __init__(
        ...
        self.thermal_template = "Thermal_his_{}.jpg"
        ...
        action_info, action_to_idx = mhavutils_mm_his.get_action_infos(path_action_info)
        ...
        object_info, object_to_idx = mhavutils_mm_his.get_object_infos(path_object_info)
        ...
        self.hand_labels, self.subjects_infos = mhavutils_mm_his.get_all_hand_labels('../data_MHAV/annotation_0317.xlsx', self.rgb_root, self.rgb_template, self.depth_root, self.depth_template, self.thermal_root, self.thermal_template)
    ...
    def load_dataset(self):
            ...
            for name in self.subjects_infos[sub]:
                ...
                for iidx in range(int(frame_idx)):
                    ...
                    modal_paths.append({
                        ...
                        "thermal": os.path.join(base_dir, "Thermal_his", "processed_270_480", self.thermal_template.format(iidx)),
                    })
        ...
        window_starts, fulls = mhavutils_mm_his.get_seq_map(
