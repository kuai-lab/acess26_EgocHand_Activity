...
from datasets import mhavutils_mm_overlay
...
class MHAVhands(object):
    def __init__(
        ...
        action_info, action_to_idx = mhavutils_mm_overlay.get_action_infos(path_action_info)
        ...
        object_info, object_to_idx = mhavutils_mm_overlay.get_object_infos(path_object_info)
        ...
        self.hand_labels, self.subjects_infos = mhavutils_mm_overlay.get_all_hand_labels('../data_MHAV/annotation_0317.xlsx', self.rgb_root, self.rgb_template, self.depth_root, self.depth_template, self.thermal_root, self.thermal_template)
    ...
    def load_dataset(self):
        ...
        window_starts, fulls = mhavutils_mm_overlay.get_seq_map(
